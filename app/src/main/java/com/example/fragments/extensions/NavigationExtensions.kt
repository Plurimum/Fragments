    ...
    setOnNavigationItemSelectedListener { item ->
        ...
        if (fragmentManager.isStateSaved) {
            ...
            if (selectedItemTag != newlySelectedItemTag) {
                // Pop everything above the first_navigation fragment (the "fixed start destination")
                ...
                // Exclude the first_navigation fragment tag because it's always in the back stack.
                if (firstFragmentTag != newlySelectedItemTag) {
                    // Commit a transaction that cleans the back stack and adds the first_navigation fragment
